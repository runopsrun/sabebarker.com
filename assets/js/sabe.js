...
(function(i) {
    ...
    i(function() {
        ...
        i('.sb-example-indeterminate [type="checkbox"]').prop("indeterminate", true);
        i('.sb-content [href="#"]').click(function(t) {
            t.preventDefault()
        });
        ...
        i(".sb-toggle-animated-progress").on("click", function() {
        ...
        i("figure.highlight, div.highlight").each(function() {
            var t = '<div class="sb-clipboard"><button type="button" class="btn-clipboard" title="Copy to clipboard">Copy</button></div>';
            i(this).before(t);
        ...
        anchors.add(".sb-content > h2, .sb-content > h3, .sb-content > h4, .sb-content > h5");
        i(".sb-content").children("h2, h3, h4, h5").wrapInner('<span class="sb-content-title"></span>');
